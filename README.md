...
Там работает определение юр.лиц, регистрация и сильно урезанная личка.
Мы переписали парсер для извлечения юр.лиц, уже на сайте. Он теперь, похоже, даже не косячит(бот еще не обновлен). 
